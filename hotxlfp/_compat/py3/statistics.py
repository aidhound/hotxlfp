# -*- coding: utf-8 -*-
# This was literally copied from python 3 source and made compatible with py2
# See: https://github.com/python/cpython/blob/master/LICENSE
"""
...
from math import hypot, sqrt, fabs, exp, erf, log, fsum
...
def fmean(data):
    ...
    try:
        ...
        ndic = {'n': 0} # this was just n = 0
        def count(x): # and in this function we had nonlocal n
            ndic['n'] += 1
            return x
...
class NormalDist:
    ...
    def __repr__(self):
        return '(%(name)s)(mu=%(mu)s, sigma=%(sigma)s)' % {'name':type(self).__name__, 'sigma': repr(self.sigma), 'mu': repr(self.mu)}
